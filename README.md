# Sales Operations & Workforce CRM
...
4. **Campaign-Configurable Shift Schedules**: Each campaign defines shift hours, late grace windows, and commission rates.
...
6. **3 Floor Scheduled Breaks + Live Stopwatch**: Evening Tea, Floor Dinner, Midnight Coffee, and Custom Breaks with countdown timers.
7. **Fast 11-Field Lead Intake (`Ctrl+N`)**: Modal capturing all 11 fields with campaign-scoped mobile duplicate prevention.
